...
Issues and specs (you may know a spec as a PRD) for this repo live as markdown files in `docs/planning/`. These files are committed to git — they are part of the repo, not a scratch area.
